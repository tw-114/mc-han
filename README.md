...
`v0.7.0-alpha.2` 是新版 PySide6 界面的 Windows x64 MVP 预览版。下载 ZIP 后完整解压，
...
dist\mc-han-windows-x64-v0.7.0-alpha.2.zip
dist\mc-han-windows-x64-v0.7.0-alpha.2.sha256
```
